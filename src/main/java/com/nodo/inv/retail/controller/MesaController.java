...
import com.nodo.inv.retail.dto.MesaDTO;
import com.nodo.inv.retail.service.MesaService;
...
public class MesaController {
    ...
    @Autowired
    private com.nodo.inv.retail.repository.ActividadOperativaRepository actividadRepo;
    ...
    public ResponseEntity<?> obtenerActividadDeMesa(@PathVariable Long empresaId, @PathVariable Integer idMesaLocal) {
        ...
        List<com.nodo.inv.retail.entity.ActividadOperativa> actividades = actividadRepo.findByEmpresaAndMesaLocal(empresaId, idMesaLocal);
